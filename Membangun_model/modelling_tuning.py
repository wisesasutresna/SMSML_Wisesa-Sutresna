...
def setup_tracking_env():
    ...
    if dagshub_owner and dagshub_repo:
        ...
        # Cek port 5000 untuk mencegah koneksi yang hang
...
def log_evaluation_metrics(model, X_test, y_test, best_params):
    """Melakukan evaluasi model dan mencatat seluruh parameter, metrik, serta model ke MLflow."""
    ...
    with mlflow.start_run(run_name="GB_Tuned_Manual"):
        ...
        # Pembuatan dan logging minimal 2 artefak tambahan (Persyaratan Advanced)
        print("Menyimpan artefak tambahan evaluasi...")
        ...
        # Artefak 3: Teks Laporan Laporan Klasifikasi
        ...
        # Hapus berkas lokal setelah selesai di-upload ke MLflow
